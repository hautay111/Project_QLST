...
public class Barcode_Scanner extends javax.swing.JFrame implements Runnable, ThreadFactory {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Barcode_Scanner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new Barcode_Scanner().setVisible(true);
        });
    }
    ...
    public void run() {
        do {
            ...
            if (result != null) {
                ...
                String lala = result_field.getText();
