...
import app.controller.homepage.EncryptorAES;
...
public class security {
    ...
    @FXML
    void btn_login(ActionEvent event) throws InvalidKeyException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, BadPaddingException, IllegalBlockSizeException, SQLException, IOException {
...
//						stage.setScene(scene);
	...
	public void getOrderId(String ID_ORDER) {
		order_id.setText(ID_ORDER);
		a=order_id.getText();
		System.out.println("ID ORDER: "+a);
	}
}
