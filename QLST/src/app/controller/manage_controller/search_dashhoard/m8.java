...
public class m8 implements Initializable{
	Connection conn = null;
	ResultSet rs = null;
	PreparedStatement pst = null;
	int index=-1;
	ObservableList<M8> listC;
    ...
    @FXML
    private TableView<M8> table_m8;
    
    @FXML
    private TableColumn<M8, Integer> col_no;

    @FXML
    private TableColumn<M8, Integer> col_id;

    @FXML
    private TableColumn<M8, String> col_pro_name;
...
//		----------------------------chart-----------------------------------------------------
	...
	@FXML
	void tableQuarter1() {
		col_no.setCellValueFactory(new PropertyValueFactory<M8, Integer>("no"));
		col_id.setCellValueFactory(new PropertyValueFactory<M8, Integer>("pro_id"));
		col_pro_name.setCellValueFactory(new PropertyValueFactory<M8, String>("pro_name"));
		col_amount.setCellValueFactory(new PropertyValueFactory<M8, Integer>("amount"));		
		listC = connectDB.getDataM8();
		table_m8.setItems(listC);
	}
}
