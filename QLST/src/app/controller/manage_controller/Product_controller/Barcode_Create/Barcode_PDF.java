package app.controller.manage_controller.Product_controller.Barcode_Create;
...
//	}
	...
	public static void createPDF(String pdfFilename,String myString) {
	    ...
	    try {
	        ...
	        docWriter = PdfWriter.getInstance(doc, new FileOutputStream("C:\\Users\\hau\\git\\Project_QLST\\QLST\\src\\app\\controller\\manage_controller\\Product_controller\\Barcode_Create\\Image_Barcode\\"+pdfFilename));
